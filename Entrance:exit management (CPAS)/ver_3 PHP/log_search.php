...
<html>
  <head>
    <link rel="stylesheet" href="log_search.css">
  ...
  <body>
    ...
    <section class="detail">
      <form action="log_all.php?page=search" method="post">
        <div class="btn1">
          ...
          <button type="submit" class="back1"><i class="fa fa-search"></i></button>
            ...
            <h2 class="text1">Log Detail Search</h2>
                <div>
            ...
            <input type="radio" id="att" name="att" value="guest">GUEST
                ...
                <div>
                    <label class="text" for="date">Date<br></label>
                    <input class="s" id="date" type="text" name="date" value="">
                </div>
            </form>
        </section>
    </main>
